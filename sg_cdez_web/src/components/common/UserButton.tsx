...
export function UserButton() {
  ...
  return (
    <Group gap="sm" wrap="nowrap" className={classes.user}>
      <Avatar src="/default-avt-light.jpg" radius="lg" alt="Usuario" />

      <Stack gap={0} style={{ flex: 1, minWidth: 0 }}>
        <Text size="sm" fw={500} truncate="end">
          {user?.nombreCompleto.length != 0
            ? user?.nombreCompleto
            : "Sin Nombre"}
        </Text>
      ...
      >
        ...
        <Menu.Dropdown>
          ...
          <Menu.Divider />
          <Menu.Label>Ajustes de usuario</Menu.Label>
          <Menu.Item
            leftSection={<BsPersonFill size={20} />}
          ...
          <Menu.Item
            color="red"
            leftSection={<BsBoxArrowRight size={20} />}
